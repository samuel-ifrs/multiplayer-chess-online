...
export async function findByUsername(username: string): Promise<PlayerRow | null> {
...
export async function createPlayer(username: string, passwordHash: string): Promise<PlayerRow> {
