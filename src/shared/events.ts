...
export interface ClientToServerEvents {
  ...
  'lobby:create': (payload: CreateRoomPayload, ack: (res: Ack<{ roomId: string }>) => void) => void
  'lobby:join': (payload: JoinRoomPayload, ack: (res: Ack<GameSnapshot>) => void) => void
  'game:rejoin': (payload: RoomIdPayload, ack: (res: Ack<GameSnapshot>) => void) => void
