...
export type TimeControlId = '1+1' | '3+0' | '3+1' | '10+0' | '10+5' | '15+0' | 'inf'
...
export const TIME_CONTROLS: Record<TimeControlId, TimeControl> = {
  ...
  '10+0': { id: '10+0', initialMinutes: 10, incrementSeconds: 0, label: '10 + 0' },
  '10+5': { id: '10+5', initialMinutes: 10, incrementSeconds: 5, label: '10 + 5' },
  '15+0': { id: '15+0', initialMinutes: 15, incrementSeconds: 0, label: '15 + 0' },
